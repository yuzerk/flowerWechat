...
//var NewApiRootUrl = 'http://192.168.0.103:8081/app/';
var NewApiRootUrl = 'http://192.168.0.104:8081/app/';

module.exports = {
  IndexUrlNewGoods: NewApiRootUrl + 'commodity/getCommodities', //
  IndexUrlHotGoods: NewApiRootUrl + 'index/hotGoods', //首页数据接口
  IndexUrlTopic: NewApiRootUrl + 'commodity/getSubject', //首页数据接口
  ...
  IndexUrlBanner: NewApiRootUrl + 'commodity/getSubject', //首页数据接口IndexUrlChannel
  IndexUrlChannel: NewApiRootUrl + 'index/channel', //首页数据接口IndexUrlChannel
  IndexUrlSkill: NewApiRootUrl + 'index/secKill', //首页秒杀产品
  CatalogList: NewApiRootUrl + 'commodity/classifyTabBar',  //分类目录全部分类数据接口
  CatalogCurrent: NewApiRootUrl + 'commodity/classifyTabChange',  //分类目录当前分类数据接口

  AuthLoginByWeixin: NewApiRootUrl + 'user/login', //微信登录
  ...
  GoodsDetail: NewApiRootUrl + 'commodity/getCommodities',  //获得商品的详情
  ...
  CartList: NewApiRootUrl + 'shopping/cart/list', //获取购物车的数据
  CartAdd: NewApiRootUrl + 'shopping/cart/create', // 添加商品到购物车
  ...
  CartGoodsCount: NewApiRootUrl + 'shopping/cart/count', // 获取购物车商品件数
  ...
  CouponList: NewApiRootUrl + 'userCoupon/getByUid', // 优惠券列表
